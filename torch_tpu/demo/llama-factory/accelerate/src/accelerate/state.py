...
def get_sophgo_chip():
    import os
    return list(map(int, os.environ.get('CHIPS', '0').split(',')))
    ...
    **Available attributes:**
    ...
    def __init__(self, cpu: bool = False, **kwargs):
        ...
        if 1:
            ...
            elif check_sophgo_tpu() and not cpu:
                self.distributed_type = DistributedType.NO
                self.num_processes = 1
                self.process_index = 0
                self.local_process_index = 0
                self.device = torch.device("tpu:"+str(get_sophgo_chip()[0]))
            elif (
...
class AcceleratorState:
    ...
    **Available attributes:**
    ...
    def __repr__(self):
        ...
        if not hasattr(self, "distributed_type") : self.distributed_type = DistributedType.NO
