...
class fx2mlir(object):
    ...
    def fix(self):
        os.system(f"gen_rand_input.py  --mlir {self.top_mlir} --output input_ref_bp.npz")
        data = np.load("input_ref_bp.npz")
    ...
    def start_cmp(self):
        if hasattr(self.args, "cmp"):
            self.fix()
            # os.system(f"gen_rand_input.py  --mlir {self.top_mlir} --output input_ref.npz")
            os.system(f"model_runner.py --input input_ref.npz --model {self.top_mlir} --output top.npz")
            self.fix_output()
            os.system(f"model_runner.py --input input_ref.npz --model {self.tpu_mlir} --output tpu.npz")
            os.system(f"model_runner.py --input input_ref.npz --model {self.bmodel_path} --output bmodel.npz")
            os.system(f"npz_tool.py compare cpu.npz top.npz -v")
            os.system(f"npz_tool.py compare top.npz tpu.npz -v")
            os.system(f"npz_tool.py compare tpu.npz bmodel.npz -v")
            os.system(f"npz_tool.py compare cpu.npz tpu.npz -v")
            os.system(f"npz_tool.py compare cpu.npz bmodel.npz -v")
