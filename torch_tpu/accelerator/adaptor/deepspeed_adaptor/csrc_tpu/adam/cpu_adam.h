...
public:
    ...
    {
        _doubled_buffer[0] = new ds_half_precision_t[TILE];
        _doubled_buffer[1] = new ds_half_precision_t[TILE];
        if(_doubled_buffer == nullptr || _doubled_buffer == nullptr){
    ...
    ~Adam_Optimizer()
    {
        delete[] _doubled_buffer[0];
        delete[] _doubled_buffer[1];
    }
...
private:
    ...
    ds_half_precision_t* _doubled_buffer[2];
    bool _buf_index;
    bool _adamw_mode;
