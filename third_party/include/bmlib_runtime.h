...
#define bmkernel_load_firmware tpu_kernel_load_firmware
DECL_EXPORT bm_status_t tpu_kernel_load_firmware(
        bm_handle_t  handle,
        const char  *firmware_tcm,
        const char  *firmware_ddr);

DECL_EXPORT bm_status_t tpu_kernel_launch_async(
        bm_handle_t   handle,
...
DECL_EXPORT bm_status_t tpu_kernel_sync(bm_handle_t handle);
