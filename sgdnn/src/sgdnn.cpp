                       ...
                       SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_rsqrt", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_rsqrt_t api;
  api.input_global_addr = input.addr;
  api.output_global_addr = output.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_rsqrt_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                       ...
                       SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_sinh", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_sinh_t api;
  api.input_global_addr = input.addr;
  api.output_global_addr = output.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_sinh_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                       ...
                       SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_cosh", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_cosh_t api;
  api.input_global_addr = input.addr;
  api.output_global_addr = output.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_cosh_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                       ...
                       SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_tanh", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_tanh_t api;
  api.input_global_addr = input.addr;
  api.output_global_addr = output.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_tanh_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
...
bm_status_t sgdnnEqualBcast ( bm_handle_t handle,
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_equal_bcast", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_equal_bcast_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
...
bm_status_t sgdnnGeBcast ( bm_handle_t handle,
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_greater_or_equal_bcast", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_ge_bcast_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
...
bm_status_t sgdnnGtBcast ( bm_handle_t handle,
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_greater_bcast", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_gt_bcast_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
...
bm_status_t sgdnnLe ( bm_handle_t handle,
  ...
  api.dtype = sgdnnTPUKernelDType(input.dtype);
  SAFE_CALL(sgdnnTPUKernelLaunch(handle, "tpu_kernel_api_less_than_or_equal", &api, sizeof(api)));
#elif defined SGDNN_BACKEND_2260
  sg_api_le_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
...
bm_status_t sgdnnLeBcast ( bm_handle_t handle,
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_less_than_or_equal_bcast", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_le_bcast_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
...
bm_status_t sgdnnLeC ( bm_handle_t handle,
  ...
  api.const_value = scalar;
  api.dtype = sgdnnTPUKernelDType(input.dtype);
  SAFE_CALL(sgdnnTPUKernelLaunch(handle, "tpu_kernel_api_less_than_or_equal_c", &api, sizeof(api)));
#elif defined SGDNN_BACKEND_2260
  sg_api_le_c_t api;
  api.input_global_addr = input.addr;
  api.output_global_addr = output.addr;
...
bm_status_t sgdnnLt ( bm_handle_t handle,
  ...
  api.dtype = sgdnnTPUKernelDType(input.dtype);
  SAFE_CALL(sgdnnTPUKernelLaunch(handle, "tpu_kernel_api_less_than", &api, sizeof(api)));
#elif defined SGDNN_BACKEND_2260
  sg_api_lt_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
...
bm_status_t sgdnnLtBcast ( bm_handle_t handle,
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_less_than_bcast", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_lt_bcast_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
...
bm_status_t sgdnnLtC ( bm_handle_t handle,
  ...
  api.const_value = scalar;
  api.dtype = sgdnnTPUKernelDType(input.dtype);
  SAFE_CALL(sgdnnTPUKernelLaunch(handle, "tpu_kernel_api_less_than_c", &api, sizeof(api)));
#elif defined SGDNN_BACKEND_2260
  sg_api_lt_c_t api;
  api.input_global_addr = input.addr;
  api.output_global_addr = output.addr;
...
bm_status_t sgdnnNotEqual ( bm_handle_t handle,
  ...
  api.dtype = sgdnnTPUKernelDType(input.dtype);
  SAFE_CALL(sgdnnTPUKernelLaunch(handle, "tpu_kernel_api_not_equal", &api, sizeof(api)));
#elif defined SGDNN_BACKEND_2260
  sg_api_not_equal_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
...
bm_status_t sgdnnNotEqualBcast ( bm_handle_t handle,
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_not_equal_bcast", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_not_equal_bcast_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
...
bm_status_t sgdnnNotEqualC ( bm_handle_t handle,
  ...
  api.const_value = scalar;
  api.dtype = sgdnnTPUKernelDType(input.dtype);
  SAFE_CALL(sgdnnTPUKernelLaunch(handle, "tpu_kernel_api_not_equal_c", &api, sizeof(api)));
#elif defined SGDNN_BACKEND_2260
  sg_api_not_equal_c_t api;
  api.input_global_addr = input.addr;
  api.output_global_addr = output.addr;
                        ...
                        SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_minimumc", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_minimumc_t api;
  api.input_global_addr = input.addr;
  api.output_global_addr = output.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_minimumc_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                        ...
                        SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_minimum", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_minimum_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_minimum_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                        ...
                        SgdnnTensor_t output )
{
  ...
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_minimum_bcast", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_minimum_bcast_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( other.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_minimum_bcast_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                        ...
                        SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_maximumc", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_maximumc_t api;
  api.input_global_addr = input.addr;
  api.output_global_addr = output.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_maximumc_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                        ...
                        SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_maximum", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_maximum_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_maximum_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                        ...
                        SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( other.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_maximum_bcast", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_maximum_bcast_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( other.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_maximum_bcast_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                        ...
                        SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( output.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_atan2c", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_atan2c_t api;
  api.other_global_addr = other.addr;
  api.output_global_addr = output.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( output.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_atan2c_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                        ...
                        SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( output.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_atan2_c", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_atan2_c_t api;
  api.input_global_addr = input.addr;
  api.output_global_addr = output.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( output.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_atan2_c_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                        ...
                        SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( output.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_atan2", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_atan2_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( output.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_atan2_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                        ...
                        SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( other.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_atan2_bcast", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_atan2_bcast_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( other.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_atan2_bcast_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                    ...
                    SgdnnTensor_t output)
{
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
#if defined SGDNN_BACKEND_1684X
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_silu", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_silu_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                    ...
                    SgdnnTensor_t output)
{
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
#if defined SGDNN_BACKEND_1684X
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_sigmoid", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_sigmoid_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                        ...
                        SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_fmaxc", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_fmaxc_t api;
  api.input_global_addr = input.addr;
  api.output_global_addr = output.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_fmaxc_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                        ...
                        SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_fmax", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_fmax_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_fmax_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                        ...
                        SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( other.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_fmax_bcast", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_fmax_bcast_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( other.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_fmax_bcast_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                        ...
                        SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_fminc", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_fminc_t api;
  api.input_global_addr = input.addr;
  api.output_global_addr = output.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_fminc_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                        ...
                        SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_fmin", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_fmin_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( input.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_fmin_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
                        ...
                        SgdnnTensor_t output )
{
  ...
  api.dtype = sgdnnTPUKernelDType ( other.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_fmin_bcast", &api, sizeof ( api ) ) );
#elif defined SGDNN_BACKEND_2260
  sg_api_fmin_bcast_t api;
  api.input_global_addr = input.addr;
  api.other_global_addr = other.addr;
  ...
  api.dtype = sgdnnTPUKernelDType ( other.dtype );
  SAFE_CALL ( sgdnnTPUKernelLaunch ( handle, "tpu_kernel_api_fmin_bcast_multi_core", &api, sizeof ( api ) ) );
#else
  SGDNN_CHECK ( false );
#endif
  return BM_SUCCESS;
