 ...
 * 2. INPUT must be contiguous
 */
tpuRtStatus_t sgdnnLog ( tpuRtStream_t  stream,
                       SgdnnTensor_t input,
                       SgdnnTensor_t output,
 ...
 * 2. INPUT must be contiguous
 */
tpuRtStatus_t sgdnnSqueeze ( tpuRtStream_t  stream,
                       SgdnnTensor_t input,
                       SgdnnTensor_t output, 
                       bool non_blocking = true);
 ...
 *  3. input and other must be the same dim.
 */
tpuRtStatus_t sgdnnShiftRightArithmeticBcast ( tpuRtStream_t  stream,
                              SgdnnTensor_t input,
                              SgdnnTensor_t other,
                              SgdnnTensor_t output , 
                              bool non_blocking = true);
 ...
 * 3. INPUT, OTHER and OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnSub ( tpuRtStream_t  stream,
                       SgdnnTensor_t input,
                       SgdnnTensor_t other,
                       float scalar,
                       SgdnnTensor_t output , 
 ...
 * 3. INPUT, OTHER and OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnMul ( tpuRtStream_t  stream,
                       SgdnnTensor_t input,
                       SgdnnTensor_t other,
                       SgdnnTensor_t output , 
                       bool non_blocking = true);
 ...
 * 3. INPUT, OTHER and OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnDiv ( tpuRtStream_t  stream,
                       SgdnnTensor_t input,
                       SgdnnTensor_t other,
                       SgdnnTensor_t output , 
                       bool non_blocking = true);
 ...
 * 3. INPUT and OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnCSub ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        float scalar,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 * 3. INPUT and OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnMulC ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        float scalar,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 * 3. INPUT and OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnCDiv ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        float scalar,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 * 3. INPUT and OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnRound (tpuRtStream_t  stream,
                       SgdnnTensor_t input,
                       SgdnnTensor_t output , 
                       bool non_blocking = true);
 ...
 * 3. INPUT and OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnBitwiseNot (tpuRtStream_t  stream,
                       SgdnnTensor_t input,
                       SgdnnTensor_t output , 
                       bool non_blocking = true);
 ...
 * 2. INPUT and OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnMinimumC ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        float scalar,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 * 3. INPUT ,OTHER and OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnMinimum ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        SgdnnTensor_t other,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 */
tpuRtStatus_t sgdnnMinimumBcast ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        SgdnnTensor_t other,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 * 2. INPUT and OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnMaximumC ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        float scalar,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 * 3. INPUT ,OTHER and OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnMaximum ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        SgdnnTensor_t other,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 * 2. INPUT, OTHER, OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnMaximumBcast ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        SgdnnTensor_t other,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 */
tpuRtStatus_t sgdnnAtan2C ( tpuRtStream_t  stream,
                        float scalar,
                        SgdnnTensor_t other,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 */
tpuRtStatus_t sgdnnAtan2_C ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        float scalar,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 */
tpuRtStatus_t sgdnnAtan2 ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        SgdnnTensor_t other,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 * 2. INPUT, OTHER, OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnAtan2Bcast ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        SgdnnTensor_t other,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 * 2. INPUT and OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnFmaxC ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        float scalar,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 * 3. INPUT ,OTHER and OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnFmax ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        SgdnnTensor_t other,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 * 2. INPUT, OTHER, OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnFmaxBcast ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        SgdnnTensor_t other,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 * 2. INPUT and OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnFminC ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        float scalar,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 * 3. INPUT ,OTHER and OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnFmin ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        SgdnnTensor_t other,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 * 2. INPUT, OTHER, OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnFminBcast ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        SgdnnTensor_t other,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 */
tpuRtStatus_t sgdnnReduceMaxOrMin ( tpuRtStream_t  stream,
                              SgdnnTensor_t input,
                              int *reduction_dim,
 ...
 */
tpuRtStatus_t sgdnnArg( tpuRtStream_t  stream,
                              SgdnnTensor_t input,
                              int axis,
                              int mode,
 ...
 */
tpuRtStatus_t sgdnnNextafterC ( tpuRtStream_t  stream,
                        float scalar,
                        SgdnnTensor_t other,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 * 3. OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnNextafter_C ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        float scalar,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 * 3. INPUT ,OTHER and OUTPUT must be contiguous
 */
tpuRtStatus_t sgdnnNextafter ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        SgdnnTensor_t other,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 */
tpuRtStatus_t sgdnnNextafterBcast ( tpuRtStream_t  stream,
                        SgdnnTensor_t input,
                        SgdnnTensor_t other,
                        SgdnnTensor_t output , 
                        bool non_blocking = true);
 ...
 */
tpuRtStatus_t sgdnnPad ( tpuRtStream_t  stream,
                       SgdnnTensor_t input,
                       int *pad,
                       int pad_size,
                       float value,
 ...
 *  3. input and output must be contiguous
 */
tpuRtStatus_t sgdnnSliceScatter ( tpuRtStream_t  stream,
                       SgdnnTensor_t input,
                       SgdnnTensor_t src,
                       SgdnnTensor_t indices,
                       int dim,
