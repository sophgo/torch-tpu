...
def test_deepseek_moe(batch_size, input_w, middle_w, num_experts, num_experts_per_tok):
    ...
    if num_experts == 256 and batch_size == 8:
        selected_experts = torch.tensor([
            ...
            [140, 160, 216, 208,  90, 147, 171, 223]]) # default int64_t
    else:
        selected_experts = torch.randint(0, num_experts, (batch_size, num_experts_per_tok))
