...
def case1():
    ...
    output_cpu_aten=torch.ops.aten.asin(input_origin)
    output_tpu_aten=torch.ops.aten.asin(input_tpu).cpu()
    output_cpu_prims=torch.ops.prims.asin(input_origin)
    output_tpu_prims=torch.ops.prims.asin(input_tpu).cpu()
