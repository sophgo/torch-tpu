...
def case1():
    ...
    output_cpu_aten=torch.ops.aten.acos(input_origin)
    output_tpu_aten=torch.ops.aten.acos(input_tpu).cpu()
    output_cpu_prims=torch.ops.prims.acos(input_origin)
    output_tpu_prims=torch.ops.prims.acos(input_tpu).cpu()
