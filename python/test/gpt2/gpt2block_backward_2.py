...
def hook_module(layer, tpu_layer):
    grads_inp = []
    grads_out = []
    def hook(module, grad_input, grad_output):
        grads_inp.append(grad_input)
        grads_out.append(grad_output)
    handle = layer.register_backward_hook(hook)
    handle_tpu = tpu_layer.register_backward_hook(hook)
    return grads_inp, grads_out, handle, handle_tpu
...
def case_gptblock_backward():
    ...
    grads_ln1_input = []
    grads_ln1_output = []
    def hook_ln1(module, grad_input, grad_output):
        grads_ln1_input.append(grad_input)
        grads_ln1_output.append(grad_output)
    handle_ln1 = net.ln_1.register_backward_hook(hook_ln1)
    handle_ln1_tpu = net_tpu.ln_1.register_backward_hook(hook_ln1)

    grads_cattn_input = []
    grads_cattn_output = []
    def hook_cattn(module, grad_input, grad_output):
        grads_cattn_input.append(grad_input)
        grads_cattn_output.append(grad_output)
    handle_cattn = net.ln_1.register_backward_hook(hook_cattn)
    handle_cattn_tpu = net_tpu.ln_1.register_backward_hook(hook_cattn)

    grads_cproj_input = []
    grads_cproj_output = []
    def hook_cproj(module, grad_input, grad_output):
        grads_cproj_input.append(grad_input)
        grads_cproj_output.append(grad_output)
    handle_cproj = net.ln_1.register_backward_hook(hook_cproj)
    handle_cproj_tpu = net_tpu.ln_1.register_backward_hook(hook_cproj)

    grads_ln2_input = []
    grads_ln2_output = []
    def hook_ln2(module, grad_input, grad_output):
        grads_ln2_input.append(grad_input)
        grads_ln2_output.append(grad_output)
    handle_ln2 = net.ln_1.register_backward_hook(hook_ln2)
    handle_ln2_tpu = net_tpu.ln_1.register_backward_hook(hook_ln2)

    grads_mlpfc_input = []
    grads_mlpfc_output = []
    def hook_mlpfc(module, grad_input, grad_output):
        grads_mlpfc_input.append(grad_input)
        grads_mlpfc_output.append(grad_output)
    handle_mlpfc = net.ln_1.register_backward_hook(hook_mlpfc)
    handle_mlpfc_tpu = net_tpu.ln_1.register_backward_hook(hook_mlpfc)

    grads_mlpproj_input = []
    grads_mlpproj_output = []
    def hook_mlpproj(module, grad_input, grad_output):
        grads_mlpproj_input.append(grad_input)
        grads_mlpproj_output.append(grad_output)
    handle_mlpproj = net.ln_1.register_backward_hook(hook_mlpproj)
    handle_mlpproj_tpu = net_tpu.ln_1.register_backward_hook(hook_mlpproj)
    ...
    print("=====================================================================")
    handle_ln1.remove()
    handle_ln1_tpu.remove()
    handle_cattn.remove()
    handle_cattn_tpu.remove()
    handle_cproj.remove()
    handle_cproj_tpu.remove()
    handle_ln2.remove()
    handle_ln2_tpu.remove()
    handle_mlpfc.remove()
    handle_mlpfc_tpu.remove()
    handle_mlpproj.remove()
    handle_mlpproj_tpu.remove()
