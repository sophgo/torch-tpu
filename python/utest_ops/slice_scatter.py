...
def case1():
    ...
    class Test_Module(nn.Module):
        ...
        def forward(self, input_tensor, source_tensor, dim, start, end, step):
            return torch.ops.aten.slice_scatter(input_tensor, source_tensor, dim, start, end, step)
    #step2: prepare input data, Notice that the input data will be adopted not only their shapes
    input_data = [
        [input_origin, src_origin, 2, 0, 3, 2],
    ]
