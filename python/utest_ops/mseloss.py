...
def case1():
    ...
    class Test_Module(nn.Module):
        ...
        def forward(self, input_tensor, traget_tensor):
            return self.loss(input_tensor, traget_tensor)*2
        def backward(self, input_tensor, traget_tensor):
            input_tensor.requires_grad = True
            a1=self.loss(input_tensor, traget_tensor)*2
            a1.backward()
    ...
    target_tensor = torch.rand(shape)
