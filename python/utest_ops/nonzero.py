...
def case1():
    ...
    input_data = [
        [torch.randint(10, [4], dtype=torch.int32)],
        [torch.randint(10, [4,5], dtype=torch.int32)],
        [torch.randint(10, [4,5,6], dtype=torch.int32)],
    #    [torch.randint(10, [4,5,6,7], dtype=torch.int32)],
    ]
    metric_table = ['max_diff', 'MAE']
    chip_arch_dict = {"bm1684x": 1, 'sg2260': 1}
    epsilon_dict = {'bm1684x': {'i32':1e-6}, 'sg2260': {'i32':1e-6}}
