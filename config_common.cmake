...
option(BACKEND_SG2260E        "Opt for 2260e"                                  OFF)
option(BACKEND_1686          "Opt for 1686"                                    OFF)
...
if($ENV{CHIP_ARCH} STREQUAL "bm1684x")
  ...
  if($ENV{SOC_CROSS_MODE})
    ...
    set(MCPU "cortex-a53" CACHE STRING "CPU type of the target machine")
  endif()
elseif($ENV{CHIP_ARCH} STREQUAL "sg2260")
  ...
  if(("$ENV{SOC_CROSS_MODE}" STREQUAL "ON") OR ("$ENV{SOC_MODE}" STREQUAL "ON"))
    ...
    add_definitions(-DUSING_PPL)
    remove_definitions(-DSOC_MODE)
  endif()
elseif($ENV{CHIP_ARCH} STREQUAL "sg2260e")
  set(BACKEND_1684X         0)
  set(BACKEND_SG2260        0)
  set(BACKEND_SG2260E       1)
  set(BACKEND_1686          0)
  add_definitions(-DUSING_PPL)
  add_definitions(-DBACKEND_SG2260E)
elseif($ENV{CHIP_ARCH} STREQUAL "bm1686")
  set(BACKEND_1684X         0)
  set(BACKEND_SG2260        0)
  set(BACKEND_SG2260E       0)
  set(BACKEND_1686          1)
  add_definitions(-DBACKEND_1686)
  if($ENV{SOC_CROSS_MODE})
    set(PLATFORM "aarch64" CACHE STRING "The architecture of the target machine")
    set(MCPU "cortex-a53" CACHE STRING "CPU type of the target machine")
  endif()
