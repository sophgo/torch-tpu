...
#define IS_FP20(t) ((t) == SG_DTYPE_FP20)
#define IS_FP(t) (((t) == SG_DTYPE_FP32) || ((t) == SG_DTYPE_FP16) || ((t) == SG_DTYPE_BFP16) || ((t) == SG_DTYPE_FP20) || (t) == SG_DTYPE_FP8E4M3 || (t) == SG_DTYPE_FP8E5M2)
...
static inline unsigned sg_dtype_len(sg_data_type_t t)
{
    switch (t)
    {
        ...
        case SG_DTYPE_UINT4:
        case SG_DTYPE_INT4:
        case SG_DTYPE_FP8E4M3:
        case SG_DTYPE_FP8E5M2:
            return 1;
        case SG_DTYPE_FP16:
        case SG_DTYPE_BFP16:
...
typedef struct nnvlc_param {
    int do_compress;
    int do_decompress;
    int bias0;
    int bias1;
    int zero_guard;
} __attribute__((packed)) nnvlc_param_t;
...
#ifndef WIN32
} __attribute__((packed)) sccl_args_t;
#else
} sccl_args_t;
#endif
