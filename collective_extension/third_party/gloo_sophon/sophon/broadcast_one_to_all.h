...
class BroadcastOneToAll : public Algorithm {
 public:
  BroadcastOneToAll(
    ...
    SOPHON_ENFORCE_GE(rootRank_, 0);
    SOPHON_ENFORCE_LT(rootRank_, contextSize_);
    SOPHON_ENFORCE_GE(rootPointerRank_, 0);
    SOPHON_ENFORCE_LT(rootPointerRank_, ptrs_.size());
