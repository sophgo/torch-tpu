...
class PairwiseExchange: public Algorithm {
 public:
  explicit PairwiseExchange(
    ...
    SOPHON_ENFORCE_EQ(this->contextSize_ % 2, 0);
    SOPHON_ENFORCE_GT(bytesPerMsg_, 0);
    SOPHON_ENFORCE_GT(numDestinations_, 0);
    SOPHON_ENFORCE_LE(numDestinations_, log2(this->contextSize_));
