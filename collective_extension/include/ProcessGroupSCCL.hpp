...
// ProcessGroupSCCL implements Gloo bindings for c10d.
//
...
public:
  static c10::intrusive_ptr<ProcessGroup> createProcessGroupSCCL(
  ...
  static void ProcessGroupSCCLConstructor() __attribute__((constructor)) {
    ...
    register_backend("SCCL", py::cpp_function(createProcessGroupSCCL));
  }
};
