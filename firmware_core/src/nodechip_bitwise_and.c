...
void tpu_kernel_api_bitwise_and(const void *args) {
    ...
    tpu_initialize();
    nodechip_bitwise_and(api->input_global_addr,
...
TPUKERNEL_FUNC_REGISTER(tpu_kernel_api_bitwise_and);

void tpu_kernel_api_bitwise_and_multi_core(const void *args) {
    sg_api_bitwise_and_t *api = (sg_api_bitwise_and_t*)args;
    TPUKERNEL_ASSERT(api->dtype == DT_INT32 || api->dtype == DT_UINT32 ||
                     api->dtype == DT_INT8 || api->dtype == DT_UINT8);
    ...
    nodechip_bitwise_and(api->input_global_addr + (length_slice * core_idx) * tpu_data_type_size(api->dtype),
...
TPUKERNEL_FUNC_REGISTER(tpu_kernel_api_bitwise_and_multi_core);

void nodechip_bitwise_and_bcast(
global_addr_t input_global_addr,
global_addr_t other_global_addr,
global_addr_t output_global_addr,
...
void tpu_kernel_api_bitwise_and_bcast(const void *args) {
    sg_api_bitwise_and_bcast_t *api = (sg_api_bitwise_and_bcast_t*) args;
    ...
    tpu_initialize();
    nodechip_bitwise_and_bcast(api->input_global_addr,
                               api->other_global_addr,
                               api->output_global_addr,
                               &input_shape,
                               &other_shape,
...
TPUKERNEL_FUNC_REGISTER(tpu_kernel_api_bitwise_and_bcast);

void nodechip_bitwise_andc(
global_addr_t input_global_addr,
global_addr_t output_global_addr,
scalar_t value,
int length,
...
void tpu_kernel_api_bitwise_andc(const void *args) {
    sg_api_bitwise_andc_t *api = (sg_api_bitwise_andc_t*)args;
    TPUKERNEL_ASSERT(api->dtype == DT_INT32 || api->dtype == DT_UINT32 ||
                     api->dtype == DT_INT8 || api->dtype == DT_UINT8);
    ...
    tpu_initialize();
    nodechip_bitwise_andc(api->input_global_addr,
                          api->output_global_addr,
                          value,
                          length,
                          (data_type_t)api->dtype);
...
TPUKERNEL_FUNC_REGISTER(tpu_kernel_api_bitwise_andc);

void tpu_kernel_api_bitwise_andc_multi_core(const void *args) {
    sg_api_bitwise_andc_t *api = (sg_api_bitwise_andc_t*)args;
    TPUKERNEL_ASSERT(api->dtype == DT_INT32 || api->dtype == DT_UINT32 ||
                     api->dtype == DT_INT8 || api->dtype == DT_UINT8);
    ...
    nodechip_bitwise_andc(api->input_global_addr + (length_slice * core_idx) * tpu_data_type_size(api->dtype),
                          api->output_global_addr + (length_slice * core_idx) * tpu_data_type_size(api->dtype),
                          value,
                          cur_length_slice,
                          (data_type_t)api->dtype);
...
TPUKERNEL_FUNC_REGISTER(tpu_kernel_api_bitwise_andc_multi_core);
