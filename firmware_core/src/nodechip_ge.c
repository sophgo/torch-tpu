...
void nodechip_greater_or_equal(
...
void tpu_kernel_api_greater_or_equal(const void *args) {
    sg_api_ge_t *api = (sg_api_ge_t*) args;
    int length = 1;
    ...
    nodechip_greater_or_equal(api->input_global_addr,
...
TPUKERNEL_FUNC_REGISTER(tpu_kernel_api_greater_or_equal);

void nodechip_greater_or_equal_bcast(
global_addr_t input_global_addr,
global_addr_t other_global_addr,
global_addr_t output_global_addr,
...
void tpu_kernel_api_greater_or_equal_bcast(const void *args) {
    ...
    tpu_initialize();
    nodechip_greater_or_equal_bcast(api->input_global_addr,
                                    api->other_global_addr,
                                    api->output_global_addr,
                                    &input_shape,
                                    &other_shape,
...
TPUKERNEL_FUNC_REGISTER(tpu_kernel_api_greater_or_equal_bcast);

void nodechip_greater_or_equal_c(
global_addr_t input_global_addr,
global_addr_t output_global_addr,
scalar_t value,
int length,
...
void tpu_kernel_api_greater_or_equal_c(const void *args) {
    sg_api_ge_c_t *api = (sg_api_ge_c_t*)args;
    scalar_t value;
    ...
    nodechip_greater_or_equal_c(api->input_global_addr,
                                api->output_global_addr,
                                value,
                                length,
                                api->dtype);
...
TPUKERNEL_FUNC_REGISTER(tpu_kernel_api_greater_or_equal_c);