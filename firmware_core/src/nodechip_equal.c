...
void tpu_kernel_api_equal_bcast(const void *args) {
    ...
    tpu_initialize();
    nodechip_equal_bcast(api->input_global_addr,
                         api->other_global_addr,
                         api->output_global_addr,
                         &input_shape,
                         &other_shape,
...
TPUKERNEL_FUNC_REGISTER(tpu_kernel_api_equal_bcast);
