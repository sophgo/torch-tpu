...
// extern void global_pooling_data_split_stride_gt_15(
//     const dim4 *ishape,
//     const dim4 *oshape,
//     const int kh,
//     const int kw,
...
// extern void _extract_w_pooling(
...
//   global_pooling_data_split_stride_gt_15(
//       &ishape,
//       &oshape,
//       kh,
//       kw,
...
// extern int global_pooling_data_split(int input_n, int input_c, int input_h,
//                                      int input_w, int output_h, int output_w,
//                                      int kh, int kw, int dh, int dw, int pad_h,
//                                      int pad_w, int stride_h, data_type_t dtype,
...
// extern void nodechip_reduce_hw(global_addr_t ifmap_offset_global,
//                                global_addr_t ofmap_offset_global,
//                                const int *input_shape, unsigned long lens,
//                                int method, data_type_t dtype);
// extern void nodechip_const_binary_fp(global_addr_t ofmap_offset_global,
//                                      global_addr_t out_offset_global,
//                                      const int *output_shape, int in1, int in2,
//                                      int in3, int BINARY_MUL, data_type_t dtype,
//                                      int if_relu, int relu_upper_limit);
...
//     data_type_t     dtype
// ) {
//   bool global_pooling = input_h == kh && input_w == kw && pad_h == 0 &&
//                         pad_h_after == 0 && pad_w == 0 && pad_w_after == 0 &&
//                         ((stride_h == 1 && stride_w == 1) || (stride_h == kh && stride_w == kw)) && 
...
//             );
//         }
//     } else if (input_h == 1 && input_w == 1) { //global_pooling
//       unsigned int cpy_count = input_n * input_c * input_h * input_w;
//       tpu_gdma_system_cpy(ofmap_offset_global, ifmap_offset_global, cpy_count,
//                           dtype);
//     } else {
//         int method = is_avg_pooling? (if_relu ? REDUCE_SUM : REDUCE_MEAN): REDUCE_MAX;
//         const int input_shape[]= {input_n, input_c, input_h, input_w};
...
//             const int output_shape[] = {input_n, input_c, 1, 1};
