...
void tpu_kernel_api_not_equal(const void *args) {
    sg_api_not_equal_t *api = (sg_api_not_equal_t*) args;
    int length = 1;
    ...
    tpu_initialize();
    nodechip_not_equal(api->input_global_addr,
...
TPUKERNEL_FUNC_REGISTER(tpu_kernel_api_not_equal);

void nodechip_not_equal_bcast(
global_addr_t input_global_addr,
global_addr_t other_global_addr,
global_addr_t output_global_addr,
...
void tpu_kernel_api_not_equal_bcast(const void *args) {
    sg_api_equal_bcast_t *api = (sg_api_equal_bcast_t*) args;
    ...
    tpu_initialize();
    nodechip_not_equal_bcast(api->input_global_addr,
                             api->other_global_addr,
                             api->output_global_addr,
                             &input_shape,
                             &other_shape,
...
TPUKERNEL_FUNC_REGISTER(tpu_kernel_api_not_equal_bcast);

void nodechip_not_equal_c(
global_addr_t input_global_addr,
global_addr_t output_global_addr,
scalar_t value,
int length,
...
void tpu_kernel_api_not_equal_c(const void *args) {
    sg_api_not_equal_c_t *api = (sg_api_not_equal_c_t*)args;
    scalar_t value;
    ...
    nodechip_not_equal_c(api->input_global_addr,
                         api->output_global_addr,
                         value,
                         length,
                         api->dtype);
...
TPUKERNEL_FUNC_REGISTER(tpu_kernel_api_not_equal_c);