...
void tpu_kernel_api_maximumc(const void *args) {
    ...
    tpu_initialize();
    nodechip_maximumc(api->input_global_addr,
                         api->scalar,
...
void tpu_kernel_api_maximumc_multi_core(const void *args) {
    ...
    nodechip_maximumc(api->input_global_addr + (length_slice * core_idx) * tpu_data_type_size(api->dtype),
                         api->scalar,
...
void tpu_kernel_api_maximum(const void *args) {
    ...
    tpu_initialize();
    nodechip_maximum(api->input_global_addr,
...
void tpu_kernel_api_maximum_multi_core(const void *args) {
    ...
    nodechip_maximum(api->input_global_addr + (length_slice * core_idx) * tpu_data_type_size(api->dtype),
...
void tpu_kernel_api_maximum_bcast(const void *args) {
    ...
    tpu_initialize();
    nodechip_maximum_bcast(api->input_global_addr,
                         api->other_global_addr,
                         api->output_global_addr,
                         &input_shape,
                               &other_shape,
