...
{
  const int batch = 64;
  test ( { batch,   64, 112 }, 1e-5, { true, true, true } ); // 0
  test ( { batch,   64,  56 }, 1e-5, { true, true, true } ); // 1
  test ( { batch,  256,  56 }, 1e-5, { true, true, true } ); // 2
  test ( { batch,  128,  56 }, 1e-5, { true, true, true } ); // 3
  test ( { batch,  128,  28 }, 1e-5, { true, true, true } ); // 4
  test ( { batch,  512,  28 }, 1e-5, { true, true, true } ); // 5
  test ( { batch,  256,  28 }, 1e-5, { true, true, true } ); // 6
  test ( { batch,  256,  14 }, 1e-5, { true, true, true } ); // 7
  test ( { batch, 1024,  14 }, 1e-5, { true, true, true } ); // 8
  test ( { batch,  512,  14 }, 1e-5, { true, true, true } ); // 9
  test ( { batch,  512,   7 }, 1e-5, { true, true, true } ); // 10
  test ( { batch, 2048,   7 }, 1e-5, { true, true, true } ); // 11
  return 0;
}
