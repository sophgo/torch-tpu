                          ...
                          std::array<bool, 3> output_mask )
{
  ...
  auto save_mean_cpu = torch::randn ( { num_features } ) - 0.5;
  ...
  auto outputs_cpu = native_batch_norm_backward (
                     ...
                     c10::optional<at::Tensor> ( save_mean_cpu ),
                     c10::optional<at::Tensor> ( save_invstd_cpu ),
                     true,
                     eps,
                     output_mask );
  auto outputs_tpu = native_batch_norm_backward (
                     ...
                     c10::optional<at::Tensor> ( save_mean_tpu ),
                     c10::optional<at::Tensor> ( save_invstd_tpu ),
                     true,
                     eps,
                     output_mask );
