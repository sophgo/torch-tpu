...
if __name__ == "__main__":
    ...
    os.system(f"python ../preprocess_data.py --input output.json --vocab-file gpt2-vocab.json --dataset-impl mmap --tokenizer-type GPT2BPETokenizer --merge-file gpt2-merges.txt --output-prefix=gpt_training_data --append-eod --workers {os.cpu_count()}")
    os.chdir("..")